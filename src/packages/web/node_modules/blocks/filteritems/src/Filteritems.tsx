        ...
        <TouchableOpacity activeOpacity={1} style={styles.modalContainer}>
          <View style={styles.sortByContiner}>
            <View style={styles.sortRow}>
              ...
              <TouchableOpacity onPress={() => this.setState({ showSortByModal: false }, () => this.setState({ showSortByModal: false }))}>
    ...
    return (
      ...
      <SafeAreaView style={styles.mainContainer}>
        ...
        <View style={styles.sortHeader}>
          <TouchableOpacity style={{ flex: 1, justifyContent: 'center', flexDirection: 'row', }} onPress={() => this.setState({ showSortByModal: true })}>
            <Image source={SORT_ICON} style={{ height: scale(15), width: scale(15), resizeMode: "contain", alignSelf: 'center' }} />
          ...
          <TouchableOpacity style={{ flex: 1, justifyContent: 'center', flexDirection: 'row' }}
            ...
            <Image source={FILTER_ICON} style={{ height: scale(15), width: scale(15), resizeMode: "contain", alignSelf: 'center' }} />
