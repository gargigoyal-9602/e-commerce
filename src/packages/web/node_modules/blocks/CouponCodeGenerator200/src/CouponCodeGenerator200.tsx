...
import CouponCodeGenerator200Controller, {
  Props,
  configJSON
} from "./CouponCodeGenerator200Controller";

export default class CouponCodeGenerator200 extends CouponCodeGenerator200Controller {
