...
export default class SingleOrdersController extends BlockComponent<
  ...
  getOrders() {
    ...
    // // https://ecommerceapp-39394-ruby.39394.dev.ap-southeast-1.aws.svc.builder.ai/bx_block_order_management/orders
    // axios.get("https://ecommerceapp-39394-ruby.39394.dev.ap-southeast-1.aws.svc.builder.ai/bx_block_order_management/orders", header)
    //   .then(res => {
    //     if (res?.data?.data?.order) {
    //       this.setState({ orders: res?.data?.data?.order });
    //     }
    //   })
    //   .catch(error => {
    //     console.error(error);
  ...
  confirmCancelOrder() {
    ...
    // axios.put(`bx_block_order_management/orders/${order.id}/cancel_order`, {}, header)
    //   .then(res => {
    //     if (res.data?.data) {
    //       const { message } = res.data.data;
    //       // @ts-ignore
    //       window.notify([{ message: message || "Order cancelled successfully!!!", type: "success" }]);
    //     }
    //     // if (res?.data?.data?.order) {
