...
import { buildImg, emptyCheck, checkCheck, closeImg } from './assets';
                        ...
                        <div className='profile-pg-address-list bg-white radius-10 profile-pg-mb-30'>
                          <div className="d-flex flex-wrap align-items-center">
                            <div className="pp-sa-img-wrap1 d-flex">
                              <img src={require('./images/address-icn.png')} width='65' height='65' />
                            ...
                            <div className='pp-sa-action-wrap d-flex align-items-end justify-content-end'>
                              <div className='pp-sa-edit pr-3 border-right'>
                                <Button color='link pp-add-edit-btn' className='addressbtn' onClick={() => this.setState({ ...this.state, editAddressChecked: true, addressIndex: index, deliveryAddressID: ele.attributes.id })}>
                                  {content.edit}
                                </Button>
                              </div>
