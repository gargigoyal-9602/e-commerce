              ...
              this.props.order.attributes.order_items.map((item: any, index: any) => {
                ...
                */}
                      ...
                      >
                        ...
                        <img
                          src={item.attributes && item.attributes.product_images && item.attributes.product_images.data ? item.attributes.product_images.data[0].attributes.url : item.product_image}
                          className="img-fluid"
                        />
                      </div>
                        ...
                        <div className="order-product-info">
                          ...
                          <div className="order-prodict-type-container">
                            {item.attributes?.catalogue_variant?.attributes?.product_variant_properties ? <Table className="mb-0 order-prodict-type d-block" borderless>
                              <thead>
                                <tr>
                                  {item.attributes?.catalogue_variant?.attributes?.product_variant_properties.map((value: any) => (<th>{value.variant_name?.toUpperCase()}</th>))}
                                </tr>
                              </thead>
                              <tbody>
                                <tr>
                                  {item.attributes?.catalogue_variant?.attributes?.product_variant_properties.map((value: any) => (<td>{value.property_name}</td>))}
                                </tr>
                              </tbody>
                            </Table> : <div></div>}
                          </div>
