...
import CustomisedOrderStatus200Controller, {
  Props,
  configJSON
} from "./CustomisedOrderStatus200Controller";

export default class CustomisedOrderStatus200 extends CustomisedOrderStatus200Controller {
