...
export default class Orderdetailview extends OrderdetailviewController {
  ...
  renderSubsctionOrdersView = () => {
    ...
    let productImage = "";
    if (product_varient_images && product_varient_images.images.length > 0) {
            ...
            <View style={styles.reviewPopup}>
              ...
              <View style={styles.starContainer}>
                {this.state.ratingList.map((item: any) => {
                  return (
                    <TouchableOpacity key='ratingList' onPress={() => this.onPressStar(item)}>
                      <Image
                        source={
                          item.isSelected
                            ? item.selectedStar
