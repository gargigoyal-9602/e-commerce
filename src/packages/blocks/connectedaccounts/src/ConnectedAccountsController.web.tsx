...
export default class ConnnectedAccountsController extends BlockComponent<Props, S, SS>{
    ...
    getAllSocialAccountsList = () => {
        ...
        requestMessage.addData(getName(MessageEnum.RestAPIResponceEndPointMessage), configJSON.getconnectedAccountsApiEndPoint);
    ...
    activateSocialAccount = (data: any, socialMediaName: string) => {
        ...
        requestMessage.addData(getName(MessageEnum.RestAPIResponceEndPointMessage), configJSON.addSocialConnectedAccountsApiEndPoint);
        const headers = {
            'Content-Type': 'application/json',
            token
        };
    ...
    deActivateSocialAccount = () => {
        ...
        requestMessage.addData(getName(MessageEnum.RestAPIResponceEndPointMessage), configJSON.removeSocialConnectedAccountsApiEndPoint + '/' + id);
