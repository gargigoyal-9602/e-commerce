...
> {
  ...
  removedRedundantSortFilterParams = () => {
    ...
    if(localFilterParams.includes('sort[order_by]=price&sort[direction]=asc')) {
      localFilterParams = localFilterParams.replace('sort[order_by]=price&sort[direction]=asc', '');
    }
    if(localFilterParams.includes('sort[order_by]=price&sort[direction]=desc')) {
      localFilterParams = localFilterParams.replace('sort[order_by]=price&sort[direction]=desc', '');
    }
    if(localFilterParams.includes('sort[order_by]=created_at&sort[direction]=desc')) {
      localFilterParams = localFilterParams.replace('sort[order_by]=created_at&sort[direction]=desc', '');
    }
    if(localFilterParams.includes('sort[order_by]=sold&sort[direction]=desc')) {
      localFilterParams = localFilterParams.replace('sort[order_by]=sold&sort[direction]=desc', '');
    }
