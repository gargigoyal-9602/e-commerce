...
import ShippingChargeCalculator200Controller, {
  Props,
  configJSON
} from "./ShippingChargeCalculator200Controller";

export default class ShippingChargeCalculator200 extends ShippingChargeCalculator200Controller {
